...
import { Rocket, Gamepad2, Keyboard, MousePointer2, Trophy } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-b from-[#0a0a1a] via-[#0d0d2b] to-[#0a0a1a] flex flex-col items-center justify-center z-50 overflow-hidden">
      ...
      >
        ...
        <button
          onClick={handleStart}
          className="group relative w-64 h-16 mx-auto block overflow-hidden rounded-lg bg-gradient-to-r from-cyan-500 to-fuchsia-500 p-0.5 transition-all duration-300 hover:scale-105 hover:shadow-[0_0_40px_rgba(34,211,238,0.5)]"
        >
